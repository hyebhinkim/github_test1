...
def test_user_02_0030(driver_fixture):
    ...
    step_3_fail_message = "아이디 형식 에러 메세지가 노출되지 않음"
    add_user.email.send_keys("test@labelearth")
    ...
    assert is_text_present(driver_fixture, "이메일 형식이 올바르지 않습니다."), step_3_fail_message

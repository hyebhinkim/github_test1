...
def test_project_02_0330(driver_fixture):
    ...
    step_3_fail_message = "라벨 클래스가 삭제 되지 않음"
    create.delete_label.click()
    assert not is_text_present(driver_fixture, 'label-1'), step_3_fail_message

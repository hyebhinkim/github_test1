...
@pytest.fixture
def driver(request, driver_kwargs):
    ...
    for retry in Retrying(
        ...
        with retry:
            ...
            driver = webdriver.Chrome(options=chrome_options)  # Chrome 예제
    ...
    if event_listener is not None:
        ...
        if not isinstance(driver, webdriver.EventFiringWebDriver):
            driver = webdriver.EventFiringWebDriver(driver, event_listener())
